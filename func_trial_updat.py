...
#behaviour of the soot load files
    ...
    for i in range(rw_index.shape[1]):
        if i == 0:
            ...
            region_of_interest_1[region_of_interest_1.isin(store_region)]
    ...
    if ans_1 == 'y':
        ...
        param_plot[~param_plot.index.isin(region_of_interest_1.iloc[:,0])] = None
    ...
    while ans_3 == 'y':
        ...
        if ans_2 == 'y':
            ...
            if ans_4 == 'y':
                ...
                param_comp[~param_comp.index.isin(region_of_interest_2.iloc[:,0])] = None
                ...
                param_comp[~param_comp.index.isin(region_of_interest_3.iloc[:,0])] = None
...
def subset_region(param_del,z):
    ...
    if z == 0:
        ...
        for i in range(col-1,0,-1):
            ...
            param_df = param_df.loc[param_df.index.isin(col_ind.values)]
...
def temp_index_extract(my_path,tcc,z):
    import os
    import pandas as pn
    import numpy as np
    import func_trial as ft
...
def temp_parameter_extract(my_path,temp_file, tcc):
    ...
    mypath = my_path
    fi = ft.temp_index_extract(my_path,tcc,5)
    file_index = fi[0]
    temp_value = fi[1]
    tempfile = temp_file
