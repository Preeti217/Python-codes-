# -*- coding: utf-8 -*-
"""
Created on Mon Feb 08 10:39:25 2016
...
mypath = 'C:\Users\Preeti\Desktop\CTS\MTU Data'
...
for num in range(len(tempfile)):
    ...
    column_name = ['K' + str(cycle_ind[num])]
    ...
    ro_name = 'K' + str(cycle_ind[num]) +'.csv'
